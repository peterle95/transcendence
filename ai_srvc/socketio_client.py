...
ssl_context.load_verify_locations('/usr/local/share/ca-certificates/root_projecy_ca.crt')
...
def create_client(model: Optional[DQNNetwork], ai_slot: int, room_id: str, bot_mode: str = "model") -> socketio.AsyncClient:
    ...
    """
    sio = socketio.AsyncClient(reconnection=True, reconnection_attempts=0, ssl_verify=False)
